...
```sh
python -m http.server 8080 --bind 127.0.0.1 --directory docs/interactive-demo
```
...
[Hosted demo](https://project-atlas-six-delta.vercel.app/projects/entity-resolution-workbench/) · [Contact](mailto:mehajardian@gmail.com)
